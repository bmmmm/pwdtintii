# Opt-in short aliases for pwdtintii (fish variant). Source AFTER the plugin:
#   source ~/path/to/pwdtintii/pwdtintii.plugin.fish
#   source ~/path/to/pwdtintii/examples/aliases.fish
#
